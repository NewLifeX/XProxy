...
namespace NewLife.Net.Http
{
    ...
    public class HttpHeader
    {
        ...
        public Boolean IsResponse => String.IsNullOrEmpty(Method);
        ...
        /// <summary>头部</summary>
        public IDictionary<String, String> Headers => _Headers ??= new HeaderCollection();

        /// <summary>是否完整Http头。是否双换行结束</summary>
        public Boolean IsFinish { get; private set; } = true;
        ...
        #region 扩展属性
        /// <summary>主机头</summary>
        public String Host { get => Headers["Host"]; set => Headers["Host"] = value; }

        /// <summary>引用页</summary>
        public String Referer { get => Headers["Referer"]; set => Headers["Referer"] = value; }

        /// <summary>重定向地址</summary>
        public String Location { get => Headers["Location"]; set => Headers["Location"] = value; }

        /// <summary>内容长度</summary>
        public Int32 ContentLength { get => Headers["Content-Length"].IsNullOrWhiteSpace() ? 0 : Int32.Parse(Headers["Content-Length"]); set => Headers["Content-Length"] = value.ToString(); }

        /// <summary>内容类型</summary>
        public String ContentType { get => Headers["Content-type"]; set => Headers["Content-type"] = value; }

        /// <summary>是否保持连接</summary>
        public String Connection { get => Headers["Connection"]; set => Headers["Connection"] = value; }

        /// <summary>是否保持连接</summary>
        public Boolean KeepAlive { get => !"Close".EqualIgnoreCase(Connection); set => Connection = value ? "keep-alive" : "Close"; }

        /// <summary>是否保持代理连接</summary>
        public String ProxyConnection { get => Headers["Proxy-Connection"]; set => Headers["Proxy-Connection"] = value; }

        /// <summary>是否保持代理连接</summary>
        public Boolean ProxyKeepAlive { get => !"Close".EqualIgnoreCase(ProxyConnection); set => ProxyConnection = value ? "Keep-Alive" : "Close"; }

        /// <summary>原始地址。直接代理会包括全路径</summary>
        public String RawUrl => Url != null && Url.IsAbsoluteUri ? Url.ToString() : String.Format("http://{0}{1}", Host, Url);
        #endregion
        ...
        #region 辅助
        private class HeaderCollection : Dictionary<String, String>, IDictionary<String, String>
        {
